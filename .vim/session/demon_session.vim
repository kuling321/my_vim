...
set cscopequickfix=s-,c-,i-,d-,t-,e-
set cscopetag
...
set shortmess=aoO
badd +1752 ~/shuge/net/emac/wemac.c
badd +495 ~/shuge/linux-2.6.29.1/include/linux/kernel.h
badd +339 ~/shuge/linux-2.6.29.1/drivers/net/wemac.c
badd +619 ~/shuge/linux-2.6.29.1/kernel/workqueue.c
badd +286 ~/shuge/net/dm9000.c
badd +2066 ~/shuge/linux-2.6.29.1/drivers/net/e100.c
args ~/shuge/net/emac/wemac.c
edit ~/shuge/[File\ List]
...
exe 'vert 1resize ' . ((&columns * 25 + 87) / 175)
exe '2resize ' . ((&lines * 31 + 32) / 65)
exe 'vert 2resize ' . ((&columns * 25 + 87) / 175)
exe '3resize ' . ((&lines * 31 + 32) / 65)
exe 'vert 3resize ' . ((&columns * 74 + 87) / 175)
exe '4resize ' . ((&lines * 31 + 32) / 65)
exe 'vert 4resize ' . ((&columns * 74 + 87) / 175)
exe '5resize ' . ((&lines * 31 + 32) / 65)
exe 'vert 5resize ' . ((&columns * 149 + 87) / 175)
argglobal
enew
file __Tag_List__
let s:cpo_save=&cpo
...
wincmd w
argglobal
edit ~/shuge/linux-2.6.29.1/drivers/net/e100.c
setlocal noarabic
setlocal noautoindent
setlocal autoread
setlocal nobinary
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 2066 - ((10 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2066
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 286 - ((15 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
286
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1093 - ((12 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1093
